    ...
    <>
      ...
      <div>
          ...
          <div className="px-40 py-6 flex gap-8">
            ...
            <div className="flex-1 py-2">
              ...
              <p className="text-white mb-4">
                {movie.first_air_date} • {movie.episode_run_time?.[0] || "N/A"} min •{" "}
              ...
              <div className="mt-4 flex flex-wrap gap-4 text-white items-center">
                <div>
                ...
                {trailer && (
                  <button
                    className="bg-[#22b9d6] cursor-pointer text-black font-semibold px-4 py-2 rounded-lg hover:scale-105 transition-transform"
        ...
        <div className="mb-10 px-40">
          <h2 className="text-2xl font-bold m-4 text-white">Top Billed Cast</h2>
